...
<!-- Donation section -->
<section id="donation-section" class="w-full h-full min-h-fit lg:min-h-[80vh] flex justify-center items-end lg:items-center bg-white bg-gradient-to-tr from-teal-300/70 via-teal-50 to-white/80 pt-32 xl:pt-48 pb-20 px-6 md:px-16">
				
  <!-- hero inner container -->
  <div class="w-full max-w-screen-xl grid grid-cols-12 gap-6 md:gap-10 h-fit">

    <!-- left panel -->
    <div class="col-span-12 md:col-span-6 lg:col-span-7 flex flex-col gap-4 lg:gap-4 justify-between">
      
      <!-- top -->
      <div class="flex flex-col gap-4 lg:gap-4 ">
        <p class="w-fit border border-teal-600 px-3 py-1 text-xs text-teal-800 bg-teal-200/50 font-normal rounded-full">Donation Drive</p>
        ...
        <p class="text-base lg:text-base text-balance">Mass for You at Home continues to broadcast every Sunday thanks to the support and contributions of people like you.</p>
  
        <!-- buttons -->
        <div class="flex flex-row sm:flex-row w-full sm:w-fit gap-2 mt-4 md:mt-4">
          <a href="<?php echo get_site_url(); ?>/mass-archives" class="flex justify-center items-center gap-1 text-xs lg:text-base font-bold uppercase tracking-wider px-8 py-4 hover:-translate-y-1 bg-black hover:bg-teal-800 text-teal-50 border-2 border-black hover:border-teal-800 transition duration-300"><i class='bx bx-play-circle text-xl'></i>View Mass Archives</a>
          <a href="<?php echo get_site_url(); ?>/about" class="flex justify-center items-center gap-1 text-xs lg:text-base font-bold uppercase tracking-wider px-8 py-4 hover:-translate-y-1 bg-transparent hover:bg-teal-500 text-black hover:text-white border border-black hover:border-teal-500 transition duration-300"><i class='bx bx-info-circle text-xl'></i>Learn More</a>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="flex flex-row gap-4 items-start mt-4 md:mt-6 text-black -translate-y-3 border-t border-black border-dotted pt-4">
          <div>
            <p class="text-xs lg:text-sm uppercase opacity-80">Available on these platforms</p>
          </div>
