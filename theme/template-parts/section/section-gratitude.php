...
<section id="donation-section" class="w-full flex justify-center items-end lg:items-center bg-white bg-gradient-to-bl md:bg-gradient-to-tr from-teal-300/70 via-teal-50 to-white/80 pt-32 xl:pt-32 px-6 md:px-16">
  ...
  <div class="relative z-20 w-full max-w-screen-xl grid grid-cols-12 gap-0 md:gap-10 h-fit">

    <!-- left panel -->
    <div class="h-full md:min-h-fit col-span-12 md:col-span-4 lg:col-span-4 flex flex-col gap-4 lg:gap-4 justify-start md:justify-end pt-8 md:pt-16 pb-8">
      
      <!-- top -->
      <div class="flex flex-col gap-3 lg:gap-4 ">
        <p class="w-fit border border-orange-700/70 px-3 py-1 font-heading text-xs text-white bg-orange-700/70 font-normal rounded-full">GRATITUDE</p>
        <h2 class="font-heading text-4xl md:text-5xl lg:text-6xl xl:text-6xl text-balance text-black font-semibold tracking-tight">Thank you for your donation and support.</h2>
    ...
    <!-- right panel -->
    <div class="relative col-span-12 md:col-span-8 lg:col-span-8 flex flex-row justify-end items-end gap-6 overflow-visible">
      <div class="w-fit h-full flex justify-start items-end overflow-hidden">
        
        <!-- floating image -->
        <img width="800" height="700" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/hero/mfyah_thank_you_03.png" class="hidden md:flex h-full w-full m-w-full object-cover hover:-translate-x-4 transition duration-1000 ease-out" alt="mfyah logo">
