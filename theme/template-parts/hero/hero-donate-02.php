...
<div id="hero-donate-02" class="relative z-0 w-full h-full flex justify-center items-end lg:items-center pt-24 md:pt-28 px-6 md:px-16">
				
  <!-- hero inner container -->
  <div class="relative z-20 w-full max-w-screen-xl grid grid-cols-12 gap-0 md:gap-10 h-fit py-4 lg:py-10">

    <!-- left panel -->
    <div class="h-full md:min-h-fit col-span-12 md:col-span-6 lg:col-span-6 flex flex-col gap-4 lg:gap-4 justify-start md:justify-end pt-8 md:pt-16 pb-8">
      
      <!-- top -->
      <div class="flex flex-col gap-3 lg:gap-4 ">
        <p class="w-fit border border-orange-700/70 px-3 py-1 font-heading text-xs text-white bg-orange-700/70 font-normal rounded-full">FUNDRAISING</p>
        <h2 class="font-heading text-4xl md:text-5xl lg:text-6xl xl:text-6xl text-balance text-black font-semibold tracking-tight">Your donation keeps the Sunday masses on air.</h2>
        <p class="text-sm lg:text-base text-neutral-900 text-balance font-serif">Mass for You at Home has been broadcast since August 1971. It is believed to be the longest-running religious program on Australian commercial television.</p>
  
        <!-- buttons -->
        <div class="hidden md:flex flex-row sm:flex-row w-full sm:w-fit gap-2 mt-4 md:mt-4">
          <a href="#donate-widget" class="w-full md:w-fit flex justify-center items-center gap-1 text-xs lg:text-base font-heading font-bold uppercase tracking-wider px-8 py-4 hover:-translate-y-1 bg-black hover:bg-teal-800 text-teal-50 border-2 border-black hover:border-teal-800 transition duration-300"><i class='bx bx-donate-heart text-xl'></i>Donate now</a>
      ...
      <!-- bottom -->
      <div class="hidden md:flex flex-col gap-2 mt-6 text-xs lg:text-sm font-sans opacity-80">
    ...
    <!-- right panel -->
    <div class="relative col-span-12 md:col-span-6 lg:col-span-6 flex flex-row justify-center items-center gap-6 overflow-visible">
      <div id="donate-widget" class="w-full h-full flex justify-start items-end overflow-hidden px-0 lg:px-6 py-2 md:py-8 pb-12">
